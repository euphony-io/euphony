...
#ifndef EUPHONY_EPNYAUDIOSTREAMCALLBACK_H
#define EUPHONY_EPNYAUDIOSTREAMCALLBACK_H
 ...
 * blocking.
 */
class EpnyAudioStreamCallback: public DefaultAudioStreamCallback {
public:
    EpnyAudioStreamCallback(IRestartable &mParent) : DefaultAudioStreamCallback(mParent) {
...
#endif //EUPHONY_EPNYAUDIOSTREAMCALLBACK_H

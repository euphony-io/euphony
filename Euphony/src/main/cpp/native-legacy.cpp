...
Java_euphony_lib_receiver_KissFFT_create(JNIEnv *env, jobject thiz, jint numSamples) {
...
Java_euphony_lib_receiver_KissFFT_destroy(JNIEnv *env, jobject thiz, jlong handle) {
...
extern "C"
JNIEXPORT void JNICALL
Java_euphony_lib_receiver_KissFFT_spectrum_1for_1phase(JNIEnv *env, jobject thiz, jlong handle,
                                                       jobject source, jobject target) {
    KissFFT* fft = (KissFFT*)handle;
    kiss_fft_scalar* samples = (kiss_fft_scalar*)env->GetDirectBufferAddress( source );
    float* spectrum = (float*)env->GetDirectBufferAddress( target );
...
extern "C"
JNIEXPORT void JNICALL
Java_euphony_lib_receiver_KissFFT_getRealPart(JNIEnv *env, jobject thiz, jlong handle,
                                              jobject real) {
    KissFFT* fft = (KissFFT*)handle;
...
extern "C"
JNIEXPORT void JNICALL
Java_euphony_lib_receiver_KissFFT_getImagePart(JNIEnv *env, jobject thiz, jlong handle,
                                               jobject imag) {
    KissFFT* fft = (KissFFT*)handle;
